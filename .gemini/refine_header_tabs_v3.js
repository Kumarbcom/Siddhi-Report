...
function replaceBlock(fileContent, startMarker, endMarker, newContent) {
    ...
    console.log(`✅ Replacing block from ${startIdx}`);
...
const newTabCont = 'className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-1 bg-gray-100/80 p-1 rounded-xl border border-gray-200 shadow-inner w-full xl:flex-1"';
...
// Use double quotes for the string to allow single quotes inside
