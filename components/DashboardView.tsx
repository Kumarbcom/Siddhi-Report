...
const DashboardView: React.FC<DashboardViewProps> = React.memo(({
    ...
    const [activeSubTab, setActiveSubTab] = useState<'sales' | 'inventory' | 'so' | 'po' | 'weekly' | 'customerAnalysis'>('sales');
    ...
    const formatDateDisplay = (dateString: string | Date | undefined) => {
