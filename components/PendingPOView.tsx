...
import { Trash2, Download, Upload, ShoppingCart, Search, ArrowUpDown, ArrowUp, ArrowDown, AlertTriangle, Package, FileDown } from 'lucide-react';
...
const PendingPOView: React.FC<PendingPOViewProps> = ({ 
  ...
  const handleExport = () => {
    ...
    const wb = utils.book_new();
    utils.book_append_sheet(wb, ws, "Pending_PO");
    writeFile(wb, "Pending_PO_Export.xlsx");
  };
