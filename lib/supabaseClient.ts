 ...
 */
export const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || 'https://lgxzqobcabiatqoklyuc.supabase.co';
export const SUPABASE_KEY = import.meta.env.VITE_SUPABASE_KEY || 'sb_publishable_sVtiXZDvmU1g6O9V0mahDg_bJ0o94iI';
